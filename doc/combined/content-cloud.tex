...
\begin{figure}[H]
    \centering
    \subfloat[\centering Perlin]{{\includegraphics[width=3cm]{media/perlin.png} }}%
    \qquad
    \subfloat[\centering Worley]{{\includegraphics[width=3cm]{media/worley.png} }}%
...
\begin{figure}[H]
    \centering
    \subfloat[Ohne Temporal Upsampling]{{\includegraphics[height=4cm]{media/tu-left.png} }}%
    \qquad
    \subfloat[Mit Temporal Upsampling]{{\includegraphics[height=4cm]{media/tu-right.png} }}%
