#include <engine/graphics/renderer/TestRenderer.hpp>
#include <engine/graphics/VulkanAPI.hpp>
#include <engine/util/Log.hpp>

namespace en
{
	TestRenderer::TestRenderer(uint32_t width, uint32_t height) :
		m_FrameWidth(width),
		m_FrameHeight(height),
		m_VertShader("test/test.vert", false),
		m_FragShader("test/test.frag", false),
	...
	void TestRenderer::Render(VkQueue queue) const
	{
	...
	void TestRenderer::ResizeFrame(uint32_t width, uint32_t height)
	{
		m_FrameWidth = width;
		m_FrameHeight = height;
	...
	VkImage TestRenderer::GetImage() const
	{
		return m_Image;
	}

	void TestRenderer::CreateRenderPass(VkDevice device)
	{
	...
	void TestRenderer::CreatePipelineLayout(VkDevice device)
	{
	...
	void TestRenderer::CreatePipeline(VkDevice device)
	{
		// Shader stage
	...
	void TestRenderer::CreateImage(VkDevice device)
	{
		// Create Image
	...
	void TestRenderer::CreateImageView(VkDevice device)
	{
	...
	void TestRenderer::CreateFramebuffer(VkDevice device)
	{
	...
	void TestRenderer::RecordCommandBuffer()
	{
